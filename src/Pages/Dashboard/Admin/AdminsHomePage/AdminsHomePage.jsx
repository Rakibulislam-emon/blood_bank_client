...
const AdminsHomePage = () => {
    ...
    // Fetch donations data for the current period
    ...
    const totalAmount = donations.reduce((total, donation) => {
        return total + parseFloat(donation.givenAmount);
    }, 0);

    // Calculate total donated amount for the previous period
    ...
    const { data: allBloodRequests = [] } = useQuery({
        queryKey: ['allUsers'],
        queryFn: async () => {
            ...
            <div className="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4 z-10">
                ...
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    ...
                    <div className="p-4 text-right">
                        <p className="block antialiased font-sans text-sm leading-normal  text-blue-gray-600 font-semibold">Total Donations</p>
                        {totalAmount}$
                    </div>
                ...
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    ...
                    {/* alll users */}
                    <div className="p-4 text-right">
                        <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Total s Users</p>
                ...
                <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                    ...
                    <div className="p-4 text-right">
                        <p className="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">all blood requests</p>
                        <h4 className="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">{allBloodRequests.length}</h4>
                    </div>
                    <div className="border-t border-blue-gray-50 p-4">
