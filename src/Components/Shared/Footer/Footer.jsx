                ...
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="max-w-xs mt-4 text-sm text-gray-600">
                            ...
                            LifeSource Blood Bank: Your platform for seamless blood donation connections, user-friendly donor management, and impactful content sharing.       </p>
